...
func (_m *Client) ChargerConfig(chargerID string) (*easee.ChargerConfig, error) {
...
// Observations provides a mock function with given fields: chargerID, obID, from, to
func (_m *Client) Observations(chargerID string, obID easee.ObservationID, from time.Time, to time.Time) ([]easee.Observation, error) {
	ret := _m.Called(chargerID, obID, from, to)

	var r0 []easee.Observation
	if rf, ok := ret.Get(0).(func(string, easee.ObservationID, time.Time, time.Time) []easee.Observation); ok {
		r0 = rf(chargerID, obID, from, to)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]easee.Observation)
		}
	}

	var r1 error
	if rf, ok := ret.Get(1).(func(string, easee.ObservationID, time.Time, time.Time) error); ok {
		r1 = rf(chargerID, obID, from, to)
	} else {
		r1 = ret.Error(1)
	}
...
func (_m *Client) StartCharging(chargerID string, current float64) error {
